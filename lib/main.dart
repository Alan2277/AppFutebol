...
class AppFutebol extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget addTexto = const Padding(
      ...
      child: Text(
        ...
        '\n2. Precisão e finalização: Messi é um finalizador nato. Sua precisão de chute e capacidade de marcar gols em uma variedade de situações é impressionante. Ele tem um excelente controle de bola e é capaz de colocar a bola onde quer que deseje.'
        ...
        '\n5. Títulos e conquistas: Messi conquistou inúmeros títulos com o Barcelona, incluindo várias La Ligas, Copas do Rei e títulos da Liga dos Campeões. Ele também liderou a seleção argentina a vitórias importantes, incluindo a Copa América em 2021 e a Copa do Mundo em 2022.',
        softWrap: true,
        style: TextStyle(
          color: Colors.white,
        ),
    ...
    return MaterialApp(
      theme: ThemeData(
        scaffoldBackgroundColor: Color.fromARGB(255, 70, 67, 73),
      ),
      title: 'Futebol News',
      home: Scaffold(
        body: Column(
  ...
  Column _buildIcones(Color color, IconData icon, String label) {
    return Column(
      ...
      children: [
        Icon(icon, color: Color.fromARGB(255, 202, 205, 11)),
        Container(
